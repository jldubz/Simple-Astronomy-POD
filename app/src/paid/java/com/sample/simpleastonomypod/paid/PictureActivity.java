package com.sample.simpleastonomypod.paid;
...
import com.sample.simpleastronomypod.PodEntry;
import com.sample.simpleastronomypod.R;
...
public class PictureActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mThankYouButton = findViewById(R.id.button_picture_paid);
    ...
    private void ShowThankYouMessage() {
        ...
        builder.setMessage("You're awesome");
        builder.setPositiveButton("Groovy!", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialogInterface, int i) {
